...
class Login(QMainWindow):
    def __init__(self):
        super().__init__()
        uic.loadUi(r"D:\mindx\PTA\lesson8\lesson8\gui\login.ui", self)
...
class Register(QMainWindow):
    def __init__(self):
        super().__init__()
        uic.loadUi(r"D:\mindx\PTA\lesson8\lesson8\gui\register.ui", self)
...
class Main(QMainWindow):
    def __init__(self) :
        super().__init__()
        uic.loadUi(r"D:\mindx\PTA\lesson8\lesson8\gui\main.ui", self)
